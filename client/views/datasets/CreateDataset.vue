                        ...
                        <div class="steps" id="steps">
                            ...
                            <div class="steps-content">
                                ...
                                <div class="step-content has-text-centered"
                                    ...
                                    <article class="tile is-child">
                                        ...
                                        <div class="content has-text-centered">
                                            ...
                                            <p class="is-italic">Select a csv file or a zip file containing multiple
                                                csv's. Each file needs to
                                                be formatted with the same separator, which you can select below. Once
                                                you've
                                            ...
                                            <div class="file has-name is-boxed is-centered">
                                                <label class="file-label">
                                                    <input class="file-input" type="file" name="file"
                                                           accept="text/csv, application/zip, application/vnd.ms-excel, application/sql, "
                                            ...
                                            <button class="button is-link is-outlined" v-on:click="this.file = null">Cancel</button>

                                            <button class="button is-primary" v-on:click="manageCsvOrZip">Upload
                                                file
                                            </button>
                                ...
                                <div class="step-content has-text-centered"
                                    ...
                                    <div class="content">
                                        <h1>Join</h1>
                                        <p>
                                            You've uploaded multiple tables, so you can join them together. Start by
                                            choosing two tables
                                            which you want to join: this will generate a new joined table which you can
                                            use to join with
                                            other tables.
                                    ...
                                    <div class="content">
                                        ...
                                        <p>
                                            <button class="button" v-for="table in joinData"
                                                    v-on:click="selectTable(table.name)">
                                    ...
                                    <div class="content"
                                         v-bind:class="{'is-hidden' : selection1 == null || selection2 == null}">
                                            ...
                                            <div class="column">
                                                ...
                                                <div class="select">
                                                    <select v-model="joinOn1">
                                                        <option v-for="column in ActiveTable('left', 'col')">
                                                            {{column.name}}
                                                        </option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="column">
                                                ...
                                                <div class="select">
                                                    <select v-model="joinOn2">
                                                        <option v-for="column in ActiveTable('right', 'col')">
                                                            {{column.name}}
                                                        </option>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="content">
                                            ...
                                            <p>
                                                <button class="button is-primary" v-on:click="join()"
                                                        v-bind:class="{'is-hidden' : joinOn1 == null || joinOn2 == null}">
                                                    Join
                                                </button>
                                            </p>
                                            ...
                                            <p>
                                                <button class="button" v-on:click="incrementStep(1)">Keep all
                                                    tables...
                                                </button>
                                                <button class="button" v-on:click="modalActive = true">Keep only one
                                                    table...
                                                </button>
                                            </p>
                            ...
                            <div class="steps-actions">
                                ...
                                <div class="steps-action" v-on:click="incrementStep(-1)">
                                    <a class="button"
                                       v-bind:class="{'is-disabled': activeStep===1 || activeStep === 4}">Previous</a>
                                </div>
                                <div class="steps-action" v-on:click="incrementStep(1)">
                                    <a class="button"
                                       v-bind:class="{'is-disabled': activeStep===4,  'is-hidden': activeStep > 1 }">Next</a>
                                </div>
