<template>
    <div>
        <div class="content has-text-centered">
            <p class="svg">
                <svg class="svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 202.16 201.83">
                    <g class="circle">
            ...
            <h1 class="is-title is-bold">Data Wrangler</h1>

            <p>
                <strong>Data Wrangler for ADReM Data Lab</strong>
            </p>
        </div>
                    ...
                    <nav class="level">
                        <div class="level-item has-text-centered">
                            <div>
                                ...
                                <p class="title">{{ info.datasets}}</p>
                            </div>
                        </div>
                        <div class="level-item has-text-centered">
                            <div>
                                <p class="heading">Users</p>
                                <p class="title">{{ info.users }}</p>
                            </div>
                        </div>
                        <div class="level-item has-text-centered">
                            <div>
                                <p class="heading">Favored Datasets</p>
                                <p class="title">{{ info.favorites }}</p>
                            </div>
                        </div>
                    </nav>
                </article>
